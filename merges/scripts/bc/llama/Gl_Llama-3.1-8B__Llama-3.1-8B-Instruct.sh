...
OUTPUT_DIR="/scratch/evalero/projects/merge_llm/merges/models/bc/llama/gl_Llama-3.1-8B__Llama-3.1-8B-Instruct_${SLURM_JOB_ID}"

mergekit-yaml /scratch/evalero/projects/merge_llm/merges/scripts/bc/llama/gl_Llama-3.1-8B__Llama-3.1-8B-Instruct.yaml \
  "$OUTPUT_DIR" \
  --copy-tokenizer \
  --cuda \
  --low-cpu-memory \
