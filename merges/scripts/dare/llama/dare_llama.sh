...
#SBATCH --array=0-0%4
#SBATCH --output=/scratch/evalero/projects/merge_llm/merges/logs/out/dare/llama/%A_%a.out
#SBATCH --error=/scratch/evalero/projects/merge_llm/merges/logs/err/dare/llama/%A_%a.err
...
BASE_MODEL_FOR_DARE="meta-llama/Llama-3.1-8B"
...
OUT_BASE="/scratch/evalero/projects/merge_llm/merges/models/dare/llama"
