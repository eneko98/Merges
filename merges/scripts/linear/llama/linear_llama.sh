...
#SBATCH --array=0-0%4
#SBATCH --output=/scratch/evalero/projects/merge_llm/merges/logs/out/linear/llama/%A_%a.out
#SBATCH --error=/scratch/evalero/projects/merge_llm/merges/logs/err/linear/llama/%A_%a.err
...
echo "Linear (llama) merge completed: ${MODEL_NAME}"
