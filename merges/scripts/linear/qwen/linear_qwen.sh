...
#SBATCH --array=0-0%4
#SBATCH --output=/scratch/evalero/projects/merge_llm/merges/logs/out/linear/qwen/%A_%a.out
#SBATCH --error=/scratch/evalero/projects/merge_llm/merges/logs/err/linear/qwen/%A_%a.err
...
################ MODELS ################
BASE_MODEL="/data/evalero/models_original/gl_Qwen3-8B-Base"
...
OUT_BASE="/scratch/evalero/projects/merge_llm/merges/models/linear/qwen"
...
echo "Linear (qwen) merge completed: ${MODEL_NAME}"
