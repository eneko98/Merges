...
#SBATCH --array=0-0%4
#SBATCH --output=/scratch/evalero/projects/merge_llm/merges/logs/out/ta/qwen/%A_%a.out
#SBATCH --error=/scratch/evalero/projects/merge_llm/merges/logs/err/ta/qwen/%A_%a.err
...
################ MODELS ################
BASE_MODEL="/data/evalero/models_original/gl_Qwen3-14B-Base"
...
echo "Task Arithmetic (qwen) merge completed: ${MODEL_NAME}"
