#!/bin/bash
#SBATCH --job-name=ta_multi_llama
...
#SBATCH --output=/scratch/evalero/projects/merge_llm/merges/logs/out/ta/llama/%j.out
#SBATCH --error=/scratch/evalero/projects/merge_llm/merges/logs/err/ta/llama/%j.err
...
################ BASE MODEL ################
# This is the anchor for ALL deltas
...
echo "✅ Task arithmetic multilingual merge completed:"
echo "   ${MODEL_NAME}"
