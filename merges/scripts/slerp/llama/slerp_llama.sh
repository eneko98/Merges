...
#SBATCH --array=0-0%4
#SBATCH --output=/scratch/evalero/projects/merge_llm/merges/logs/out/slerp/llama/%A_%a.out
#SBATCH --error=/scratch/evalero/projects/merge_llm/merges/logs/err/slerp/llama/%A_%a.err
...
BASE_MODEL_FOR_SLERP="meta-llama/Llama-3.1-8B-Instruct"
...
OUT_BASE="/scratch/evalero/projects/merge_llm/merges/models/slerp/llama"
...
base_model: ${BASE_MODEL_FOR_SLERP}
...
echo "SLERP merge completed: ${MODEL_NAME} (t=${T})"
