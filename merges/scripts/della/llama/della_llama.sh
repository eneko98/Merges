...
#SBATCH --array=0-0%4
#SBATCH --output=/scratch/evalero/projects/merge_llm/merges/logs/out/della/llama/%A_%a.out
#SBATCH --error=/scratch/evalero/projects/merge_llm/merges/logs/err/della/llama/%A_%a.err
...
BASE_MODEL_FOR_DELLA="meta-llama/Llama-3.1-8B"
...
OUT_BASE="/scratch/evalero/projects/merge_llm/merges/models/della/llama"
...
cat > "$YAML_TMP" <<EOF
base_model: ${BASE_MODEL_FOR_DELLA}
...
echo "DELLA merge completed: ${MODEL_NAME}"
