#!/bin/bash
#SBATCH --job-name=eval_bc_flores
...
#SBATCH --array=0-3%4
#SBATCH --output=/scratch/evalero/projects/merge_llm/evaluation/logs/out/merges/qwen/bc/bc_flores_%A_%a.out
#SBATCH --error=/scratch/evalero/projects/merge_llm/evaluation/logs/err/merges/qwen/bc/bc_flores_%A_%a.err
...
echo "Running FLORES tasks for BC merge: ${model_name}"

############ OUTPUT DIRS ############
base_dir="/scratch/evalero/projects/merge_llm/evaluation"
results_dir="${base_dir}/results/merges/qwen/bc/${model_name}/flores"
mkdir -p "$results_dir"
