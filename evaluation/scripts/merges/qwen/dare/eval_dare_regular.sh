...
#SBATCH --array=0-1%4
#SBATCH --output=/scratch/evalero/projects/merge_llm/evaluation/logs/out/merges/qwen/dare/dare_regular_%A_%a.out
#SBATCH --error=/scratch/evalero/projects/merge_llm/evaluation/logs/err/merges/qwen/dare/dare_regular_%A_%a.err
...
results_dir="${base_dir}/results/merges/qwen/dare/${model_name}"
mkdir -p "$results_dir"
