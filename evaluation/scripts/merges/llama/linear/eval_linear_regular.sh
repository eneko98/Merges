...
#SBATCH --array=0-3%4
#SBATCH --output=/scratch/evalero/projects/merge_llm/evaluation/logs/out/merges/llama/linear/linear_regular_%A_%a.out
#SBATCH --error=/scratch/evalero/projects/merge_llm/evaluation/logs/err/merges/llama/linear/linear_regular_%A_%a.err
...
results_dir="${base_dir}/results/merges/llama/linear/${model_name}"
mkdir -p "$results_dir"
