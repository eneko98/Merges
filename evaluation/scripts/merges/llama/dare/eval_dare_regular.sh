#!/bin/bash
#SBATCH --job-name=eval_dare_regular
...
#SBATCH --array=0-3%4
#SBATCH --output=/scratch/evalero/projects/merge_llm/evaluation/logs/out/merges/llama/dare/dare_regular_%A_%a.out
#SBATCH --error=/scratch/evalero/projects/merge_llm/evaluation/logs/err/merges/llama/dare/dare_regular_%A_%a.err
...
############ MODELS TO EVALUATE ############
# All merges are INSTRUCT models
MODELS=(
  "dare_EU100_INS100|/data/evalero/projects/merge_llm/merges/models/dare/llama/dare_EU100_INS100"
  "dare_CAT100_INS100|/data/evalero/projects/merge_llm/merges/models/dare/llama/dare_CAT100_INS100"
  "dare_ES100_INS100|/data/evalero/projects/merge_llm/merges/models/dare/llama/dare_ES100_INS100"
  "dare_GL100_INS100|/data/evalero/projects/merge_llm/merges/models/dare/llama/dare_GL100_INS100"
)
...
echo "Running REGULAR tasks for DARE merge: ${model_name}"

############ OUTPUT DIRECTORIES ############
base_dir="/scratch/evalero/projects/merge_llm/evaluation"
results_dir="${base_dir}/results/merges/llama/dare/${model_name}"
mkdir -p "$results_dir"
