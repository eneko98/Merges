...
#SBATCH --array=0-0%4
#SBATCH --output=/scratch/evalero/projects/merge_llm/evaluation/logs/out/merges/llama/dare/dare_flores_%A_%a.out
#SBATCH --error=/scratch/evalero/projects/merge_llm/evaluation/logs/err/merges/llama/dare/dare_flores_%A_%a.err
...
results_dir="${base_dir}/results/merges/llama/dare/${model_name}/flores"
mkdir -p "$results_dir"
