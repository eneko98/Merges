#!/bin/bash
#SBATCH --job-name=eval_della_flores
...
#SBATCH --array=0-0%4
#SBATCH --output=/scratch/evalero/projects/merge_llm/evaluation/logs/out/merges/llama/della/della_flores_%A_%a.out
#SBATCH --error=/scratch/evalero/projects/merge_llm/evaluation/logs/err/merges/llama/della/della_flores_%A_%a.err
...
############ MODELS ############
MODELS=(
  "della_EU100_INS100|/data/evalero/projects/merge_llm/merges/models/della/llama/della_EU100_INS100"
)
...
echo "Running FLORES tasks for DELLA merge: ${model_name}"

############ OUTPUT DIRS ############
base_dir="/scratch/evalero/projects/merge_llm/evaluation"
results_dir="${base_dir}/results/merges/llama/della/${model_name}/flores"
mkdir -p "$results_dir"
