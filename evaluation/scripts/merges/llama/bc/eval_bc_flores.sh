...
#SBATCH --array=0-1%4
#SBATCH --output=/scratch/evalero/projects/merge_llm/evaluation/logs/out/merges/llama/bc/bc_flores_%A_%a.out
#SBATCH --error=/scratch/evalero/projects/merge_llm/evaluation/logs/err/merges/llama/bc/bc_flores_%A_%a.err
...
MODELS=(
  ...
  "cat_Llama-3.1-8B__Llama-3.1-8B-Instruct|/scratch/evalero/projects/merge_llm/merges/models/bc/llama/cat_Llama-3.1-8B__Llama-3.1-8B-Instruct"
  "gl_Llama-3.1-8B__Llama-3.1-8B-Instruct|/scratch/evalero/projects/merge_llm/merges/models/bc/llama/gl_Llama-3.1-8B__Llama-3.1-8B-Instruct"
)
...
results_dir="${base_dir}/results/merges/llama/bc/${model_name}/flores"
mkdir -p "$results_dir"
