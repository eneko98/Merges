#!/bin/bash
#SBATCH --job-name=eval_ns_flores
...
#SBATCH --array=0-0%4
#SBATCH --output=/scratch/evalero/projects/merge_llm/evaluation/logs/out/merges/llama/nearswap/ns_flores_%A_%a.out
#SBATCH --error=/scratch/evalero/projects/merge_llm/evaluation/logs/err/merges/llama/nearswap/ns_flores_%A_%a.err
...
############ MODELS ############
MODELS=(
  #"ns_EU100_INS100|/data/evalero/projects/merge_llm/merges/models/nearswap/llama/ns_EU100_INS100"
  #"ns_CAT100_INS100|/data/evalero/projects/merge_llm/merges/models/nearswap/llama/ns_CAT100_INS100"
  "ns_ES100_INS100|/data/evalero/projects/merge_llm/merges/models/nearswap/llama/ns_ES100_INS100"
)
...
echo "Running FLORES tasks for NEARSWAP merge: ${model_name}"

############ OUTPUT DIRS ############
base_dir="/scratch/evalero/projects/merge_llm/evaluation"
results_dir="${base_dir}/results/merges/llama/nearswap/${model_name}/flores"
mkdir -p "$results_dir"
