#!/bin/bash
#SBATCH --job-name=eval_ns_regular
...
#SBATCH --array=0-0%4
#SBATCH --output=/scratch/evalero/projects/merge_llm/evaluation/logs/out/merges/llama/nearswap/ns_regular_%A_%a.out
#SBATCH --error=/scratch/evalero/projects/merge_llm/evaluation/logs/err/merges/llama/nearswap/ns_regular_%A_%a.err
...
echo "Running REGULAR tasks for NEARSWAP merge: ${model_name}"

############ OUTPUT DIRECTORIES ############
base_dir="/scratch/evalero/projects/merge_llm/evaluation"
results_dir="${base_dir}/results/merges/llama/nearswap/${model_name}"
mkdir -p "$results_dir"
