#!/bin/bash
#SBATCH --job-name=eval_llama_8B_flores
...
#SBATCH --array=0-6%4
#SBATCH --output=/scratch/evalero/projects/merge_llm/evaluation/logs/out/originals/llama/eval_llama_8B_flores_%A_%a.out
#SBATCH --error=/scratch/evalero/projects/merge_llm/evaluation/logs/err/originals/llama/eval_llama_8B_flores_%A_%a.err
