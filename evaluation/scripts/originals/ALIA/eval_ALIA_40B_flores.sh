#!/bin/bash
#SBATCH --job-name=eval_ALIA_40B_flores
...
#SBATCH --array=0-0%1
#SBATCH --output=/scratch/evalero/projects/merge_llm/evaluation/logs/out/originals/ALIA/ALIA-40b-instruct-2601_flores_%A_%a.out
#SBATCH --error=/scratch/evalero/projects/merge_llm/evaluation/logs/err/originals/ALIA/ALIA-40b-instruct-2601_flores_%A_%a.err
...
results_dir="${base_dir}/results/originals/ALIA/${model_name}/flores"
mkdir -p "$results_dir"
...
for task in "${tasks_selected[@]}"; do
  ...
  model_args="pretrained=${model_path},dtype=bfloat16,enable_thinking=False,tensor_parallel_size=2,max_model_len=8192,gpu_memory_utilization=0.9,max_num_seqs=1"
